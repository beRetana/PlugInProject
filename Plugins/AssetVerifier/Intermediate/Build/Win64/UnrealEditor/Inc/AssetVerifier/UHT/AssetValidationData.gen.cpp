...
struct Z_Construct_UScriptStruct_FAssetValidationData_Statics
{
	...
	static const UECodeGen_Private::FStrPropertyParams NewProp_ValidatorName;
...
const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FAssetValidationData_Statics::NewProp_AssetName = { "AssetName", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FAssetValidationData, AssetName), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_AssetName_MetaData), NewProp_AssetName_MetaData) };
...
const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FAssetValidationData_Statics::NewProp_ValidatorName = { "ValidatorName", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FAssetValidationData, ValidatorName), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ValidatorName_MetaData), NewProp_ValidatorName_MetaData) };
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAssetValidationReport_Statics::NewProp_ValidationData_Inner = { "ValidationData", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FAssetValidationData, METADATA_PARAMS(0, nullptr) }; // 356522628
...
struct Z_CompiledInDeferFile_FID_Users_breta_Downloads_Proyectos_Personales_Unreal_PlugInProject_Plugins_AssetVerifier_Source_AssetVerifier_Public_AssetValidationData_h__Script_AssetVerifier_Statics
{
	...
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FAssetValidationData::StaticStruct, Z_Construct_UScriptStruct_FAssetValidationData_Statics::NewStructOps, TEXT("AssetValidationData"), &Z_Registration_Info_UScriptStruct_FAssetValidationData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAssetValidationData), 356522628U) },
		...
		{ FAssetValidationReport::StaticStruct, Z_Construct_UScriptStruct_FAssetValidationReport_Statics::NewStructOps, TEXT("AssetValidationReport"), &Z_Registration_Info_UScriptStruct_FAssetValidationReport, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAssetValidationReport), 84173169U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_breta_Downloads_Proyectos_Personales_Unreal_PlugInProject_Plugins_AssetVerifier_Source_AssetVerifier_Public_AssetValidationData_h__Script_AssetVerifier_2666041912(TEXT("/Script/AssetVerifier"),
	nullptr, 0,
